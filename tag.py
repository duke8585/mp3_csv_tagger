...
def parse_arguments():
    ...
    parser.add_argument('-ld', metavar='listdir', help='the absolute path/to/directory_with_folders_and_files/, e.g. /Users/max/Downloads/stuff', action='store')
...
def main():
    ...
    if (namespace.get('m', None) == 'list'):
        ...
        # CSV = open('/Users/maxrieger/Downloads/giegling_tp/songs.csv')
